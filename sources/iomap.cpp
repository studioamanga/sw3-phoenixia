...
*************************************************************
**                                                         **
******** iomap.cpp **** auteur : Vincent Tourraine **********
**                                                         **
...
swVertex getVertexFromMadMap(char * url, char what='C', int which=1) throw (ErrFile)
{
  int nb=0, nbtag=0;
  swVertex v(0,0,0);
